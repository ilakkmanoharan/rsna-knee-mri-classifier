...
Kernel `kaggle-user/rsna-knee-asra-agent-20260925-c00` v1 → submission **56541791**, COMPLETE, public **0.502**. Regression vs 0.518 and vs 0.511; do not promote `weak_rank_named`. Next spec: `weak_rank_named_mix`.
