...
def run_hypothesize(
    ...
    lines = [
        ...
        "the two heads are likely too similar under λI=3.5. Discussion 737312 notes Fluid_Sensitive",
        "== Fat_Suppression on all train series, so the extra interact dims may be copies; λI=2.0 is",
        "still the one-shot test of whether under-shrinking makes them distinctive. The next testable",
        "change is **λI=2.0** at the frozen 0.50 blend (`gold_rank_lam2`), not another blend weight.",
        "Visual MRI encoders stay out of scope until this metadata ablation beats 0.518 or is clearly",
        "falsified.",
        "",
