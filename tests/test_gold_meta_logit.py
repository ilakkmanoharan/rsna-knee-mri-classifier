...
def test_hypothesize_cycle0_is_w40(tmp_path):
    dummy = tmp_path / "dummy.md"
    dummy.write_text("x")
    md = run_hypothesize(
        tmp_path / "Hypothesis",
    ...
    text = md.read_text()
    assert "H_gold_rank_w40" in text
